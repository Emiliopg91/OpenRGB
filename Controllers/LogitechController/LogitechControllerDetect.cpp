...
#define LOGITECH_G502_X_PLUS_LIGHTSPEED_PID         0xC095
...
REGISTER_HID_DETECTOR_IPU("Logitech G502 X Plus Gaming Mouse (wired)",          DetectLogitechWired,        LOGITECH_VID, LOGITECH_G502_X_PLUS_LIGHTSPEED_PID,          2, 0xFF00, 2);
